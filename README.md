...
- **本地 AI 驱动**:
  - 集成 OpenAI Whisper 本地模型，提供高精度的语音转文字服务。
  - 集成 Real-ESRGAN 本地模型，提供 2x 和 4x 的图片超分（AI 放大）功能，显著提升模糊图片清晰度。
- **多媒体处理**:
  - **图片转换**: 支持 HEIC (iPhone) ➔ JPG/PNG，以及图片 (.jpg, .png, .webp, .bmp) ➔ PDF (.pdf) 与 PDF 转图片。
...
- **Excel (.xlsx)** ↔ CSV
- **图片 (.jpg, .png, .webp, .bmp)** ➔ PDF, **AI 放大 (x2, x4)**
- **HEIC (iPhone)** ➔ JPG, PNG, **AI 放大 (x2, x4)**
